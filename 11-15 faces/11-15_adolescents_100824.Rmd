...
write.csv(stimuli.work,"contenders_new.csv")

#location
getwd()

## How many of each are left? 
table(contenders_new$door_or_face)
sort(table(contenders_new$image_type), decreasing = TRUE)
